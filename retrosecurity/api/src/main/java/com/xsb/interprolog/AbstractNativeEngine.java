...
public abstract class AbstractNativeEngine extends AbstractPrologEngine{
    ...
    If false (the default), the initialization JNI calls run in the constructor thread, others in a separate thread.
    This flag was introduced to try to avoid some strange behavior...without success, so it's apparently irrelevant. */
